...
t_dirs = ['./', './custom_model/index_forecasting/a2c', './custom_model/index_forecasting/nets',
          './custom_model/index_forecasting/policies', './envs', './datasets']

file_lists = ['./index_forecasting_select_model.pyx', './index_forecasting_adhoc.pyx',
              './auto_clean_envs.pyx',
