...
if __name__ == '__main__':
    try:
        ...
        tf.app.flags.DEFINE_string('s_test', args.s_test, 'the start date of test data')
        tf.app.flags.DEFINE_string('e_test', args.e_test, 'the end date of test data')
        tf.app.flags.DEFINE_string('verbose', str(args.verbose), 'the end date of test data')
        tf.app.flags.DEFINE_string('forward_ndx', str(args.forward_ndx), 'forward_ndx')
        tf.app.flags.DEFINE_string('operation_mode', str(args.operation_mode), 'operation_mode')
        ...
        tf.app.flags.DEFINE_string('dataset_name', dataset_version, 'Data set name')
