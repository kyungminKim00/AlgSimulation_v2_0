...
def convert_dataset(sd_dates,
                    ...
                    historical_ar_data, historical_ar_ma_data_5, historical_ar_ma_data_10,
                    historical_ar_ma_data_20, historical_ar_ma_data_60,
                    target_data, fund_his_data_30, fund_cov_data_60, extra_cov_data_60, mask,
                    x_seq, class_names_to_ids, dataset_dir, verbose):
    ...
    _convert_dataset(date,
                     ...
                     historical_ar_reader, historical_ar_reader_ma5, historical_ar_reader_ma10,
            ...
            for i in range(start_ndx, end_ndx, stride):
                ...
                if ((i - sample_criteria_dummy_1) >= 0) and ((i + sample_criteria_dummy) < end_ndx):
                    ...
                    pk_data.append(decoder(sd_reader, sd_reader_ma5, sd_reader_ma10, sd_reader_ma20, sd_reader_ma60,
                                           ...
                                           sd_velocity_reader, sd_velocity_reader_ma5, sd_velocity_reader_ma10,
                                           sd_velocity_reader_ma20, sd_velocity_reader_ma60,
                                           historical_ar_reader, historical_ar_reader_ma5,
...
def run(dataset_dir, file_pattern='fs_v0_cv%02d_%s.tfrecord', s_test=None, e_test=None, verbose=2,
    ...
    convert_dataset(sd_dates_train,
                    ...
                    historical_ar_data_train, historical_ar_ma_data_5_train, historical_ar_ma_data_10_train,
    ...
    convert_dataset(sd_dates_test,
                    ...
                    historical_ar_data_test, historical_ar_ma_data_5_test, historical_ar_ma_data_10_test,
