import time
# when casing import error revmoves annotation
# import __init__
import numpy as np
import tensorflow as tf
from gym.spaces import Discrete, Box, MultiDiscrete
from custom_model.index_forecasting.common import batch_to_seq, seq_to_batch, Scheduler, find_trainable_variables, EpisodeStats, \
    get_by_index, check_shape, avg_norm, gradient_add, q_explained_variance, total_episode_reward_logger, \
    AbstractEnvRunner, tf_util

from rllearn import logger

from custom_model.index_forecasting.acer.buffer import Buffer
from custom_model.index_forecasting.policies.base_class_index_forecasting import ActorCriticRLModel, SetVerbosity, TensorboardWriter
...
class ACER(ActorCriticRLModel):
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            #     # self.n_act = self.action_space.shape[-1]
            #     # self.n_act = np.sum(self.action_space.nvec)
            #     # continuous = False
            #     raise NotImplementedError("WIP: Acer does not support Continuous actions yet.")
            else:
            ...
            with self.graph.as_default():
                ...
                with tf.compat.v1.variable_scope("moving_average"):
                    ...
                    # define custom_getter to replace name and apply ema
