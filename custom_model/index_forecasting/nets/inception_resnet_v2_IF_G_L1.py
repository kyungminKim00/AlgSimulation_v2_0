...
def inception_arg_scope(weight_decay=RUNHEADER.m_l1_norm,
                        use_batch_norm=True,
  ...
  """
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
                        weights_regularizer=tf.keras.regularizers.l1(weight_decay),
                        biases_regularizer=tf.keras.regularizers.l1(weight_decay)):
