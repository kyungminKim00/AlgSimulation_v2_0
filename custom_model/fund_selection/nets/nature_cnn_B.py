...
def nature_cnn(scaled_images, is_training=False, **kwargs):
    ...
    layer_1 = conv(scaled_images, 'c1', n_filters=128, filter_size=3, stride=1, init_scale=np.sqrt(2), pad='SAME', **kwargs)
    ...
    layer_2 = activ(conv(layer_1, 'c2', n_filters=256, filter_size=3, stride=1, init_scale=np.sqrt(2), **kwargs))
