...
Residual networks (Rescustom_model.nets) were proposed in:
...
def stack_blocks_dense(net, blocks, output_stride=None,
  ...
  Most Rescustom_model.nets consist of 4 ResNet blocks and subsample the activations by a
...
def resnet_arg_scope(weight_decay=0.0001,
  ...
  TODO(gpapan): The batch-normalization related default values above are
    ...
    training Rescustom_model.nets from scratch, they might need to be tuned.
