...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_6_gather_result_information(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_output, PyObject *__pyx_v_retry, PyObject *__pyx_v_soft_cond_retry, PyObject *__pyx_v_b_batch_test); /* proto */
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_12post_decision(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_selected_model); /* proto */
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_14run_s_model(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_dset_v, PyObject *__pyx_v_index_result, PyObject *__pyx_v_b_batch_test); /* proto */
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":137
 *         if self.soft_cond_retry == 0 and self.retry == 0:
 *             if float(self.vl) <= self.th_vl and float(self.pl) <= self.th_pl and \
 *                         float(self.ev) <= self.th_ev and float(self.v_c) >= self.th_v_c and \             # <<<<<<<<<<<<<<
 *                         float(self.train_c_acc) >= self.th_train_c_acc and float(self.v_mae) <= self.th_v_mae and \
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":138
 *             if float(self.vl) <= self.th_vl and float(self.pl) <= self.th_pl and \
 *                         float(self.ev) <= self.th_ev and float(self.v_c) >= self.th_v_c and \
 *                         float(self.train_c_acc) >= self.th_train_c_acc and float(self.v_mae) <= self.th_v_mae and \             # <<<<<<<<<<<<<<
 *                         float(self.v_r_acc) >= self.th_v_r_acc and float(self.v_ev) >= self.th_v_ev:
 ...
 */
    if (__pyx_t_4) {
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":140
 *                         float(self.train_c_acc) >= self.th_train_c_acc and float(self.v_mae) <= self.th_v_mae and \
 *                         float(self.v_r_acc) >= self.th_v_r_acc and float(self.v_ev) >= self.th_v_ev:
 *                     self._status_print(self.model_name, '\n [0 - {}] Init Rule Activated')             # <<<<<<<<<<<<<<
 *                     return True
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":147
 *                 if float(self.vl) <= (self.th_vl + self.retry * 0.005) and \
 *                         float(self.pl) <= (self.th_pl + self.retry * 0.01) and \
 *                         float(self.ev) <= self.th_ev and float(self.v_c) >= self.th_v_c and \             # <<<<<<<<<<<<<<
 *                         float(self.train_c_acc) >= (self.th_train_c_acc - self.retry * 0.005) and \
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":159
 *                 if float(self.vl) <= (self.th_vl + self.retry * 0.005) and \
 *                         float(self.pl) <= (self.th_pl + self.retry * 0.01) and \
 *                         float(self.ev) <= self.th_ev and float(self.v_c) >= self.th_v_c and \             # <<<<<<<<<<<<<<
 *                         float(self.train_c_acc) >= (self.th_train_c_acc - self.retry * 0.005) and \
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":171
 *                     float(self.train_c_acc) >= 0.84 and float(self.v_ev) > 0.1:
 *                 self._status_print(self.model_name, '\n [3 - {}] pick third best')
 *                 return True             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":177
 *                     float(self.train_c_acc) >= 0.84 and float(self.v_ev) > -0.1:
 *                 self._status_print(self.model_name, '\n [4 - {}] pick fourth best')
 *                 return False  # Disable             # <<<<<<<<<<<<<<
 *                 return True
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":183
 *             self._status_print(self.model_name, '\n [5 - {}] pick fifth best (pool best)')
 *             return False
 *         return False  # pick pool best model             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":189
 *     def __init__(self, tDir=None, rDir=None, max_cnt=None, select_criteria=None, soft_cond=True, th_dict=None):
 *         self.tDir = tDir
 *         self.rDir = rDir             # <<<<<<<<<<<<<<
 *         self.base = '/'.join(tDir.split('/')[:-1])
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":190
 *         self.tDir = tDir
 *         self.rDir = rDir
 *         self.base = '/'.join(tDir.split('/')[:-1])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":196
 *         self.max_cnt = max_cnt
 *         self.select_criteria = select_criteria
 *         self.soft_cond = soft_cond             # <<<<<<<<<<<<<<
 *         self.th_dict = th_dict
 ...
 */
  ...
  for (;;) {
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":206
 *         bb = list()
 *         for it in models:
 *             if it.split('_')[5] == 'v1':             # <<<<<<<<<<<<<<
 *                 bb.append(it)
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_4fill_statistics_model(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_avg_criteria, PyObject *__pyx_v_dict_str) {
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":213
 * 
 *     def fill_statistics_model(self, avg_criteria, dict_str):
 *         if dict_str == 'validate_ev':             # <<<<<<<<<<<<<<
 *             for idx in range(self.gathered_results.shape[0]):
 ...
 */
      ...
      for (;;) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":216
 *             for idx in range(self.gathered_results.shape[0]):
 *                 for item in avg_criteria:
 *                     if self.gathered_results[idx, self.dict_col2idx['model_name']] == item[0]:  # model score by criteria             # <<<<<<<<<<<<<<
 *                         self.gathered_results[idx, self.dict_col2idx['m_score']] = item[2]
 ...
 */
      ...
      for (;;) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":228
 *             for idx in range(self.gathered_results.shape[0]):
 *                 for item in avg_criteria:
 *                     if self.gathered_results[idx, self.dict_col2idx['model_name']] == item[0]:  # model score by criteria             # <<<<<<<<<<<<<<
 *                         self.gathered_results[idx, self.dict_col2idx['m_avg_r_acc']] = item[2]
...
static PyObject *__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_7_gather_result_information(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_6_gather_result_information(__pyx_self, __pyx_v_self, __pyx_v_output, __pyx_v_retry, __pyx_v_soft_cond_retry, __pyx_v_b_batch_test);
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_6_gather_result_information(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_output, PyObject *__pyx_v_retry, PyObject *__pyx_v_soft_cond_retry, PyObject *__pyx_v_b_batch_test) {
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":240
 *         self.item_container = list()
 *         gathered_results = list()
 *         column_name = None             # <<<<<<<<<<<<<<
 *         models = self.rDir
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":242
 *         column_name = None
 *         models = self.rDir
 *         if b_batch_test:             # <<<<<<<<<<<<<<
 *             models = os.listdir('./save/result/' + self.rDir)
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":250
 *         for dir_name in models:
 *             tmp_dir = './save/result/' + dir_name
 *             if b_batch_test:             # <<<<<<<<<<<<<<
 *                 tmp_dir = './save/result/' + self.rDir + '/' + dir_name
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":251
 *             tmp_dir = './save/result/' + dir_name
 *             if b_batch_test:
 *                 tmp_dir = './save/result/' + self.rDir + '/' + dir_name             # <<<<<<<<<<<<<<
 *             val_dir_return = tmp_dir + '/validation/fig_index/return/'
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":258
 * 
 *             # file validation
 *             r = re.compile(".*jpeg")             # <<<<<<<<<<<<<<
 *             r2 = re.compile(".*csv")
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":259
 *             # file validation
 *             r = re.compile(".*jpeg")
 *             r2 = re.compile(".*csv")             # <<<<<<<<<<<<<<
 *             if b_batch_test:
 ...
 */
            ...
            if (__pyx_t_12) {
              ...
              /* "AlgSimulation_v2/index_forecasting_select_model.pyx":266
 *                         if 'jpeg' in file_name:
 *                             if int(file_name.split('_')[4]) >= self.th_dict['th_epoch']:
 *                                 item = Data(rDir='./save/result/' + self.rDir, tDir=self.tDir, model_name=dir_name,             # <<<<<<<<<<<<<<
 *                                             val_dir_return=val_dir_return, val_dir_index=val_dir_index,
 ...
 */
            ...
            if (__pyx_t_12) {
              ...
              /* "AlgSimulation_v2/index_forecasting_select_model.pyx":283
 *                         for file_name in os.listdir(val_dir_return):
 *                             if 'jpeg' in file_name:
 *                                 if int(file_name.split('_')[4]) >= self.th_dict['th_epoch']:             # <<<<<<<<<<<<<<
 *                                     item = Data(rDir='./save/result', tDir=self.tDir, model_name=dir_name,
 ...
 */
              ...
              if (__pyx_t_12) {
                ...
                /* "AlgSimulation_v2/index_forecasting_select_model.pyx":284
 *                             if 'jpeg' in file_name:
 *                                 if int(file_name.split('_')[4]) >= self.th_dict['th_epoch']:
 *                                     item = Data(rDir='./save/result', tDir=self.tDir, model_name=dir_name,             # <<<<<<<<<<<<<<
 *                                                 val_dir_return=val_dir_return, val_dir_index=val_dir_index,
 ...
 */
                ...
                /* "AlgSimulation_v2/index_forecasting_select_model.pyx":288
 *                                                 test_dir_return=test_dir_return, test_dir_index=test_dir_index,
 *                                                 file_name=file_name, retry=retry, max_cnt=self.max_cnt,
 *                                                 th_m_score=[self.th_sub_score, self.select_criteria],             # <<<<<<<<<<<<<<
 *                                                 th_dict=self.th_dict, soft_cond_retry=soft_cond_retry)
 ...
 */
                ...
                /* "AlgSimulation_v2/index_forecasting_select_model.pyx":292
 *                                     self.item_container.append(item)
 *                                     gathered_results.append(item.tolist())
 *                                     column_name = item.columns             # <<<<<<<<<<<<<<
 *         self.column_name = column_name
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":296
 *         self.dict_col2idx = dict(list(zip(self.column_name, range(len(self.column_name)))))
 *         self.gathered_results = np.array(gathered_results)
 *         assert len(self.column_name) == len(gathered_results[0]), 'lens are different'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":303
 *         self.fill_statistics_model(avg_criteria, 'validate_ev')
 * 
 *         avg_criteria = self.avg_criteria(gathered_results, 'validate_r_acc')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":304
 * 
 *         avg_criteria = self.avg_criteria(gathered_results, 'validate_r_acc')
 *         pool_pick_opt1 = avg_criteria[np.argwhere(avg_criteria[:, -1] >= 0.60)][:, 0, 0].tolist()             # <<<<<<<<<<<<<<
 *         self.fill_statistics_model(avg_criteria, 'validate_r_acc')
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":308
 * 
 *         avg_criteria = self.avg_criteria(gathered_results, 'train_c_acc')
 *         pool_pick_opt2 = avg_criteria[np.argwhere(avg_criteria[:, -1] >= 0.82)][:, 0, 0].tolist()             # <<<<<<<<<<<<<<
 *         self.fill_statistics_model(avg_criteria, 'train_c_acc')
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":309
 *         avg_criteria = self.avg_criteria(gathered_results, 'train_c_acc')
 *         pool_pick_opt2 = avg_criteria[np.argwhere(avg_criteria[:, -1] >= 0.82)][:, 0, 0].tolist()
 *         self.fill_statistics_model(avg_criteria, 'train_c_acc')             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":316
 *             if cnt < pool_pick_opt.count(it) and pool_pick_opt.count(it) > 1:
 *                 cnt = pool_pick_opt.count(it)
 *                 self.pool_best = it             # <<<<<<<<<<<<<<
 * 
...
/* "AlgSimulation_v2/index_forecasting_select_model.pyx":331
 *             self.item_container[i].m_avg_train_c_acc = self.gathered_results[i][self.dict_col2idx['m_avg_train_c_acc']]
 * 
 *     def avg_criteria(self, data, criteria):  # calculate model score             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":334
 *         criteria = self.dict_col2idx[criteria]
 *         model_name = list(set(np.array(data)[:, self.dict_col2idx['model_name']]))
 *         avg_matrix = np.zeros([len(model_name), 3], dtype=np.object)             # <<<<<<<<<<<<<<
 *         avg_matrix[:, self.dict_col2idx['model_name']] = model_name
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":335
 *         model_name = list(set(np.array(data)[:, self.dict_col2idx['model_name']]))
 *         avg_matrix = np.zeros([len(model_name), 3], dtype=np.object)
 *         avg_matrix[:, self.dict_col2idx['model_name']] = model_name             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":337
 *         avg_matrix[:, self.dict_col2idx['model_name']] = model_name
 * 
 *         for idx in range(avg_matrix.shape[0]):             # <<<<<<<<<<<<<<
 *             for item in data:
 ...
 */
  ...
  for (;;) {
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":338
 * 
 *         for idx in range(avg_matrix.shape[0]):
 *             for item in data:             # <<<<<<<<<<<<<<
 *                 if (avg_matrix[idx][0] == item[self.dict_col2idx['model_name']]) and \
 ...
 */
    ...
    for (;;) {
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":339
 *         for idx in range(avg_matrix.shape[0]):
 *             for item in data:
 *                 if (avg_matrix[idx][0] == item[self.dict_col2idx['model_name']]) and \             # <<<<<<<<<<<<<<
 *                         int(item[self.dict_col2idx['id']]) >= self.th_epoch:
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":354
 *                    'test_mae', 'sub_m_score', 'm_score', 'm_avg_r_acc', 'm_avg_train_c_acc']
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_13post_decision(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_13post_decision = {"post_decision", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_13post_decision, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_13post_decision(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_self = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("AlgSimulation_v2.index_forecasting_select_model.Script.post_decision", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_12post_decision(__pyx_self, __pyx_v_self, __pyx_v_selected_model);
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_12post_decision(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_selected_model) {
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":366
 *             for fn in os.listdir(base_dir):
 *                 if 'sub_epo_' + model[self.dict_col2idx['id']] in fn and '.csv' in fn:
 *                     data = pd.read_csv(base_dir + '/' + fn)             # <<<<<<<<<<<<<<
 *                     if np.array(data['20days'])[-1] == np.array(data['P_20days'])[-1]:
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":367
 *                 if 'sub_epo_' + model[self.dict_col2idx['id']] in fn and '.csv' in fn:
 *                     data = pd.read_csv(base_dir + '/' + fn)
 *                     if np.array(data['20days'])[-1] == np.array(data['P_20days'])[-1]:             # <<<<<<<<<<<<<<
 *                         criteria_list.append((np.square(data['Return'][-10:] - data['P_return'][-10:])).mean(axis=0))
...
/* Python wrapper */
static PyObject *__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_15run_s_model(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_15run_s_model = {"run_s_model", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_15run_s_model, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16AlgSimulation_v2_30index_forecasting_select_model_6Script_15run_s_model(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_self = 0;
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_14run_s_model(__pyx_self, __pyx_v_self, __pyx_v_dset_v, __pyx_v_index_result, __pyx_v_b_batch_test);
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_6Script_14run_s_model(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_dset_v, PyObject *__pyx_v_index_result, PyObject *__pyx_v_b_batch_test) {
  int __pyx_v_b_exit;
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":375
 * 
 *     def run_s_model(self, dset_v=None, index_result=True, b_batch_test=False):
 *         b_exit = False             # <<<<<<<<<<<<<<
 *         retry = 0
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":386
 *             m_pass = False
 *             self._gather_result_information(True, retry, soft_cond_retry, b_batch_test)
 *             for item in self.item_container:             # <<<<<<<<<<<<<<
 *                 if soft_cond_retry == 5:  # pick pool best .. get reasonable models
 ...
 */
    ...
    for (;;) {
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":387
 *             self._gather_result_information(True, retry, soft_cond_retry, b_batch_test)
 *             for item in self.item_container:
 *                 if soft_cond_retry == 5:  # pick pool best .. get reasonable models             # <<<<<<<<<<<<<<
 *                     if item.model_name == self.pool_best and \
 ...
 */
        if (__pyx_t_1) {
          ...
          /* "AlgSimulation_v2/index_forecasting_select_model.pyx":392
 *                             int(item.id) >= item.th_epoch and float(item.pl) <= 1.88 and float(item.vl) <= 1.8 and \
 *                             float(item.v_ev) > 0.1:
 *                         item.selected = True             # <<<<<<<<<<<<<<
 *                         m_pass = True
 ...
 */
      /*else*/ {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":397
 *                     # model statistics test
 *                     if (item.selected is True) and \
 *                             (float(item.sub_m_score) >= item.th_sub_m_score) and \             # <<<<<<<<<<<<<<
 *                             (float(item.m_score) >= item.th_m_score) and \
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":407
 *                     selected_model.append(item.tolist())
 *                     shutil.copy2(item.test_return_file,
 *                                  '{}/R_{}'.format(item.tDir, item.test_return_file.split('/')[-1]))             # <<<<<<<<<<<<<<
 *                     if index_result:
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":408
 *                     shutil.copy2(item.test_return_file,
 *                                  '{}/R_{}'.format(item.tDir, item.test_return_file.split('/')[-1]))
 *                     if index_result:             # <<<<<<<<<<<<<<
 *                         shutil.copy2(item.test_index_file,
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "AlgSimulation_v2/index_forecasting_select_model.pyx":409
 *                                  '{}/R_{}'.format(item.tDir, item.test_return_file.split('/')[-1]))
 *                     if index_result:
 *                         shutil.copy2(item.test_index_file,             # <<<<<<<<<<<<<<
 *                                      '{}/I_{}'.format(item.tDir, item.test_index_file.split('/')[-1]))
 ...
 */
          ...
          /* "AlgSimulation_v2/index_forecasting_select_model.pyx":410
 *                     if index_result:
 *                         shutil.copy2(item.test_index_file,
 *                                      '{}/I_{}'.format(item.tDir, item.test_index_file.split('/')[-1]))             # <<<<<<<<<<<<<<
 *                     m_pass = False
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":411
 *                         shutil.copy2(item.test_index_file,
 *                                      '{}/I_{}'.format(item.tDir, item.test_index_file.split('/')[-1]))
 *                     m_pass = False             # <<<<<<<<<<<<<<
 *             pd.DataFrame(data=selected_model, columns=self.column_name).to_csv(
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":412
 *                                      '{}/I_{}'.format(item.tDir, item.test_index_file.split('/')[-1]))
 *                     m_pass = False
 *             pd.DataFrame(data=selected_model, columns=self.column_name).to_csv(             # <<<<<<<<<<<<<<
 *                 self.tDir + '/selected_model_results.csv')
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":413
 *                     m_pass = False
 *             pd.DataFrame(data=selected_model, columns=self.column_name).to_csv(
 *                 self.tDir + '/selected_model_results.csv')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":416
 * 
 *             # control searching a rule exploration
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":421
 *                     retry = retry + 1
 *                 else:  # static rules
 *                     retry = self.max_cnt + 1             # <<<<<<<<<<<<<<
 *             else:  # final decision
 ...
 */
    /*else*/ {
      ...
      if (__pyx_t_1) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":424
 *             else:  # final decision
 *                 if soft_cond_retry <= 2:  # for init and first best rules
 *                     print(' \nSelected base model by likely-hood: Disable')             # <<<<<<<<<<<<<<
 *                 else:  # likely-hood for loose rules (e.g. second, third, forth best rules.. etc),
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":448
 * 
 *                 # copy files
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":450
 *                 m_info = selected_model[idx]
 *                 shutil.copy2(m_info[self.dict_col2idx['test_return_file']],
 *                              '{}/final/R_{}'.format(m_info[self.dict_col2idx['tDir']],             # <<<<<<<<<<<<<<
 *                                                     m_info[self.dict_col2idx['test_return_file']].split('/')[-1]))
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":452
 *                              '{}/final/R_{}'.format(m_info[self.dict_col2idx['tDir']],
 *                                                     m_info[self.dict_col2idx['test_return_file']].split('/')[-1]))
 *                 if index_result:             # <<<<<<<<<<<<<<
 *                     shutil.copy2(m_info[self.dict_col2idx['test_index_file']],
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":453
 *                                                     m_info[self.dict_col2idx['test_return_file']].split('/')[-1]))
 *                 if index_result:
 *                     shutil.copy2(m_info[self.dict_col2idx['test_index_file']],             # <<<<<<<<<<<<<<
 *                                  '{}/final/I_{}'.format(m_info[self.dict_col2idx['tDir']],
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":454
 *                 if index_result:
 *                     shutil.copy2(m_info[self.dict_col2idx['test_index_file']],
 *                                  '{}/final/I_{}'.format(m_info[self.dict_col2idx['tDir']],             # <<<<<<<<<<<<<<
 *                                                         m_info[self.dict_col2idx['test_index_file']].split('/')[-1]))
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":455
 *                     shutil.copy2(m_info[self.dict_col2idx['test_index_file']],
 *                                  '{}/final/I_{}'.format(m_info[self.dict_col2idx['tDir']],
 *                                                         m_info[self.dict_col2idx['test_index_file']].split('/')[-1]))             # <<<<<<<<<<<<<<
 *                 if m_info[self.dict_col2idx['test_csv_file']] is not None:
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":456
 *                                  '{}/final/I_{}'.format(m_info[self.dict_col2idx['tDir']],
 *                                                         m_info[self.dict_col2idx['test_index_file']].split('/')[-1]))
 *                 if m_info[self.dict_col2idx['test_csv_file']] is not None:             # <<<<<<<<<<<<<<
 *                     shutil.copy2(m_info[self.dict_col2idx['test_csv_file']],
 ...
 */
      ...
      if (__pyx_t_10) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":457
 *                                                         m_info[self.dict_col2idx['test_index_file']].split('/')[-1]))
 *                 if m_info[self.dict_col2idx['test_csv_file']] is not None:
 *                     shutil.copy2(m_info[self.dict_col2idx['test_csv_file']],             # <<<<<<<<<<<<<<
 *                                  '{}/final/C_{}'.format(m_info[self.dict_col2idx['tDir']],
 ...
 */
      ...
      /* "AlgSimulation_v2/index_forecasting_select_model.pyx":462
 *                 self.printout_model_info(m_info)
 * 
 *                 b_exit = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":467
 *                 if self.soft_cond:
 *                     self.select_criteria = float(self.select_criteria - 0.1)
 *                     soft_cond_retry = soft_cond_retry + 1             # <<<<<<<<<<<<<<
 *                     retry = 0
 ...
 */
      ...
      if (__pyx_t_10) {
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":480
 * 
 *                     ## Test mode
 *                     print('\nPass data set - there is no models passing stopping criteria')             # <<<<<<<<<<<<<<
 *                     return 0
 ...
 */
        ...
        /* "AlgSimulation_v2/index_forecasting_select_model.pyx":481
 *                     ## Test mode
 *                     print('\nPass data set - there is no models passing stopping criteria')
 *                     return 0             # <<<<<<<<<<<<<<
 *         return 1
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":482
 *                     print('\nPass data set - there is no models passing stopping criteria')
 *                     return 0
 *         return 1             # <<<<<<<<<<<<<<
 * 
...
/* "AlgSimulation_v2/index_forecasting_select_model.pyx":485
 * 
 * 
...
static PyObject *__pyx_pf_16AlgSimulation_v2_30index_forecasting_select_model_print_summary(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_data_list, PyObject *__pyx_v_th_dict) {
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":486
 * 
 * def print_summary(data_list, th_dict):
 *     tmp = list()             # <<<<<<<<<<<<<<
 *     for item in data_list:
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":487
 * def print_summary(data_list, th_dict):
 *     tmp = list()
 *     for item in data_list:             # <<<<<<<<<<<<<<
 *         tmp.append(float(item.split('_')[14]))
 ...
 */
  ...
  for (;;) {
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":488
 *     tmp = list()
 *     for item in data_list:
 *         tmp.append(float(item.split('_')[14]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":490
 *         tmp.append(float(item.split('_')[14]))
 * 
 *     _str = 'f_result: {}'.format(np.mean(np.array(tmp)))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":491
 * 
 *     _str = 'f_result: {}'.format(np.mean(np.array(tmp)))
 *     for it in th_dict.items():             # <<<<<<<<<<<<<<
 *         _str = _str + ' ' + str(it[0]) + ':' + str(it[1]) + ', '
 ...
 */
  ...
  for (;;) {
    ...
    /* "AlgSimulation_v2/index_forecasting_select_model.pyx":492
 *     _str = 'f_result: {}'.format(np.mean(np.array(tmp)))
 *     for it in th_dict.items():
 *         _str = _str + ' ' + str(it[0]) + ':' + str(it[1]) + ', '             # <<<<<<<<<<<<<<
 *     fp = open('./save/result/selected/history.txt', 'a')
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":493
 *     for it in th_dict.items():
 *         _str = _str + ' ' + str(it[0]) + ':' + str(it[1]) + ', '
 *     fp = open('./save/result/selected/history.txt', 'a')             # <<<<<<<<<<<<<<
 *     print(_str, file=fp)
 ...
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":494
 *         _str = _str + ' ' + str(it[0]) + ':' + str(it[1]) + ', '
 *     fp = open('./save/result/selected/history.txt', 'a')
 *     print(_str, file=fp)             # <<<<<<<<<<<<<<
 *     fp.close()
 */
  ...
  /* "AlgSimulation_v2/index_forecasting_select_model.pyx":495
 *     fp = open('./save/result/selected/history.txt', 'a')
 *     print(_str, file=fp)
 *     fp.close()             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_codeobj__26 = (PyObject*)__Pyx_PyCode_New(14, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__25, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_init, 31, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__26)) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(1, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_get_test_csv, 72, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 72, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__31 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__30, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_get_id, 78, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__31)) __PYX_ERR(0, 78, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__33 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__32, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_get_test_result, 90, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__33)) __PYX_ERR(0, 90, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__35 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__34, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_tolist, 104, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__35)) __PYX_ERR(0, 104, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__37 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__36, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_get_columns, 112, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__37)) __PYX_ERR(0, 112, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__42 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__41, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_naive_filter, 132, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__42)) __PYX_ERR(0, 132, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__44 = (PyObject*)__Pyx_PyCode_New(7, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__43, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_init, 187, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__44)) __PYX_ERR(0, 187, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__47 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__46, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_sort, 202, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__47)) __PYX_ERR(0, 202, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__49 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__48, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_fill_statistics_model, 212, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__49)) __PYX_ERR(0, 212, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__54 = (PyObject*)__Pyx_PyCode_New(3, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__53, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_avg_criteria, 331, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__54)) __PYX_ERR(0, 331, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__58 = (PyObject*)__Pyx_PyCode_New(2, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__57, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_post_decision, 360, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__58)) __PYX_ERR(0, 360, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__60 = (PyObject*)__Pyx_PyCode_New(4, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__59, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_run_s_model, 374, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__60)) __PYX_ERR(0, 374, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__63 = (PyObject*)__Pyx_PyCode_New(2, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__62, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_index_forecasting_select_model_p, __pyx_n_s_print_summary, 485, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__63)) __PYX_ERR(0, 485, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                  test_dir_return=None, test_dir_index=None, file_name=None, retry=None,
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_1__init__, 0, __pyx_n_s_Data___init, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__26)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         for f_name in os.listdir(loc):
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_3_get_test_csv, 0, __pyx_n_s_Data__get_test_csv, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__29)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         self.pl = token[5][2:]
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_5_get_id, 0, __pyx_n_s_Data__get_id, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__31)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *             if 'jpeg' in f_name:
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_7_get_test_result, 0, __pyx_n_s_Data__get_test_result, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__33)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                 self.pl, self.vl, self.ev,
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_9tolist, 0, __pyx_n_s_Data_tolist, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__35)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 104, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                 'train_pl', 'train_vl', 'train_ev',
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_11_get_columns, 0, __pyx_n_s_Data__get_columns, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__37)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         if b_print:  # global variables
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_13_status_print, 0, __pyx_n_s_Data__status_print, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__39)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *             return False
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_4Data_15naive_filter, 0, __pyx_n_s_Data_naive_filter, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__42)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 132, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         self.tDir = tDir
 */
  __pyx_t_2 = __Pyx_Py3MetaclassPrepare((PyObject *) NULL, __pyx_empty_tuple, __pyx_n_s_Script, __pyx_n_s_Script, (PyObject *) NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, (PyObject *) NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 186, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *         self.rDir = rDir
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_1__init__, 0, __pyx_n_s_Script___init, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__44)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         bb = list()
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_3_sort, 0, __pyx_n_s_Script__sort, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__47)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 202, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         model_name = list(set(np.array(data)[:, self.dict_col2idx['model_name']]))
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_9avg_criteria, 0, __pyx_n_s_Script_avg_criteria, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__54)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 331, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                    'train_pl', 'train_vl', 'train_ev',
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_11printout_model_info, 0, __pyx_n_s_Script_printout_model_info, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__56)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 346, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         for model in selected_model:
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_13post_decision, 0, __pyx_n_s_Script_post_decision, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__58)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 360, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *         retry = 0
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_6Script_15run_s_model, 0, __pyx_n_s_Script_run_s_model, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti, __pyx_d, ((PyObject *)__pyx_codeobj__60)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 374, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     for item in data_list:
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_16AlgSimulation_v2_30index_forecasting_select_model_1print_summary, NULL, __pyx_n_s_AlgSimulation_v2_index_forecasti); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 485, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
